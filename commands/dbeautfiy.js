    ...
    try {
        ...
        if (!imagePrompt) {
            await sock.sendMessage(chatId, {
                text: 'Please provide a link for the beatify your image.\nExample: .debeautify <link>'
            }, {
                quoted: message
            });
            return;
        ...
        // Make API request
        const response = await axios.get(`https://samirxpikachuio.onrender.com/remacne?url=`, {
            params: {
                apikey: 'knightbot',
